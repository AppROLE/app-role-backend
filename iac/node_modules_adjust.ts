...
export function nodeModulesAdjust(): void {
  ...
  execSync('npm init -y');
  execSync(
    'npm install date-fns mongoose uuid dotenv nodemailer busboy @aws-sdk/client-cognito-identity-provider @aws-sdk/client-s3 @aws-sdk/client-cloudfront @aws-sdk/client-rekognition @aws-sdk/client-ses sharp'
  );
